...
if __name__ == '__main__':
    # ============================== 获取作者关键词 ==============================
    train_nameAidPid = json.load(open(r'../IJCAI-21-WhoIsWho-baseline-main/datas/train_proNameAuthorPubs.json'))
    ...
    test_nameAidPid = json.load(open(r'../IJCAI-21-WhoIsWho-baseline-main/datas/test_proNameAuthorPubs.json'))
    ...
    whole_nameAidPid = json.load(open(r'../IJCAI-21-WhoIsWho-baseline-main/datas/proNameAuthorPubs.json'))
    ...
    train_nameAidPid = json.load(open(r'../IJCAI-21-WhoIsWho-baseline-main/datas/train_proNameAuthorPubs.json'))
    train_paper_infos = json.load(open(r'../datas/Task1/train/train_pub.json'))
    train_author_ass = json.load(open(r'../IJCAI-21-WhoIsWho-baseline-main/datas/train_author_profile.json'))
    train_author_unass = json.load(open(r'../IJCAI-21-WhoIsWho-baseline-main/datas/train_author_unass.json'))
    ...
    test_author_ass = json.load(open(r'../IJCAI-21-WhoIsWho-baseline-main/datas/test_author_profile.json'))
    test_author_unass = json.load(open(r'../IJCAI-21-WhoIsWho-baseline-main/datas/test_author_unass.json'))

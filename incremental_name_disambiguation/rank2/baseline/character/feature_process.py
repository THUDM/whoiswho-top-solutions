...
class featureGeneration:
    ...
    def __loadEssential(self):
        data_dir = "paper_idf/"
        with open(data_dir + 'name_uniq_dict.json', "r",encoding='utf-8') as file:
            self.name_uniq_dict = json.load(file)
        with open(data_dir + 'venue_idf.json', "r",encoding='utf-8') as file:
            self.ven_tfidf = json.load(file)
        with open(data_dir + 'new_org_idf.json', "r",encoding='utf-8') as file:
            self.org_tfidf = json.load(file)
        with open(data_dir + 'title_idf.json', "r",encoding='utf-8') as file:

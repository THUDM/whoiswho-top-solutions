...
# CUDA_VISIBLE_DEVICES=1 python main.py --train_dir 'dataset/train1.pkl' --test_dir 'dataset/eval1.pkl'

# /data2/pangyunhe_data/githubrep/GraphCAD/dataset/train1.pkl
# /data2/pangyunhe_data/githubrep/GraphCAD/dataset/test1.pkl
# /data2/pangyunhe_data/githubrep/GraphCAD/dataset/eval1.pkl
    ...
    for epoch_num in range(args.epochs):
        ...
        if (epoch_num + 1) % args.verbose == 0:
            ...
            if maps > max_map or auc > max_auc:
                ...
                torch.save(encoder, f"model_paras/model_{str(epoch_num)}.pt")

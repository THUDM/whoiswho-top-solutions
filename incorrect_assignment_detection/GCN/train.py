...
# CUDA_VISIBLE_DEVICES=0 python traingcn.py --train_dir 'dataset/train1.pkl' --test_dir 'dataset/eval1.pkl' --log_name gcn --lr 5e-4 --min_lr 1e-4 --saved_dir gcn
...
if __name__ == "__main__":
    ...
    encoder.eval()
    with open(args.eval_dir, 'rb') as f:
